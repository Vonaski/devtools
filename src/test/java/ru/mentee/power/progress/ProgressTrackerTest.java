...
class ProgressTrackerTest {
  ...
  @Test
  @DisplayName("Должен выбрасывать IllegalArgumentException,"
      + " если пройденных уроков больше, чем всего")
  void shouldThrowExceptionWhenCompletedLessonsGreaterThanTotalLessons() {
  ...
  void shouldThrowExceptionWhenLessonsAreNegative() {
